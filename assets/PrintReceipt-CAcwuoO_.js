...
import{_ as x,j as e}from"./index-DQ-rm9EC.js";import{r as c,a as m}from"./vendor--ejHCorC.js";import{a as f,f as h}from"./SessionTimer-BqJWn26v.js";import"./axios-BOeqtr82.js";function g(r){const s=new Date,l=String(s.getDate()).padStart(2,"0"),n=String(s.getMonth()+1).padStart(2,"0"),o=s.getFullYear(),a=r!=null?String(r).padStart(3,"0"):"???";return`OPD/${l}${n}${o}/${a}`}function y({uid:r,patient:s,dailyToken:l}){const n=c.useRef(null);c.useEffect(()=>{!r||!n.current||x(async()=>{const{default:i}=await import("./JsBarcode-ARrGem50.js").then(t=>t.J);return{default:i}},__vite__mapDeps([0,1])).then(({default:i})=>{i(n.current,r,{format:"CODE128",width:1.8,height:45,displayValue:!0,fontSize:10})})},[r]);const o=new Date().toISOString(),a=l!=null?String(l):"—",p=g(l),d=m.createPortal(e.jsxs("div",{className:"print-receipt",children:[e.jsx("style",{children:`
